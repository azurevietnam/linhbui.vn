...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta http-equiv="refresh" content="30; URL=<?php echo yii\helpers\Url::home() ?>" />    <style type="">
    ...
    <body>
           <div class="add_zero" style="width: 720px; text-align: center; margin: 100px auto;">
            ...
            <p>Để quay về trang chủ bạn vui lòng <a href="<?php echo \yii\helpers\Url::home() ?>"><strong>ấn vào đây</strong></a>,hoặc hệ thống sẽ tự động quay về sau 30 giây</p>
