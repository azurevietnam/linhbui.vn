...
//    const URL_PARENT_SLUG = '_parent_slug';
    ...
    public static $all_url_params = [
        0 => ['name' => PageGroup::URL_SLUG, 'label' => '<b class="label label-primary">slug</b>'],
//        1 => ['name' => PageGroup::URL_PARENT_SLUG, 'label' => 'parent slug'],
        2 => ['name' => PageGroup::URL_CATEGORY_SLUG, 'label' => '<b class="label label-danger">category slug</b>'],
        3 => ['name' => PageGroup::URL_PARENT_CATEGORY_SLUG, 'label' => '<b class="label label-success">parent category slug</b>'],
    ];
