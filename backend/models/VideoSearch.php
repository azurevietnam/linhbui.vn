...
class VideoSearch extends Video
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'slug', 'old_slugs', 'source', 'description', 'meta_description', 'meta_title', 'meta_keywords', 'page_title', 'h1', 'image', 'image_path', 'created_at', 'created_by', 'updated_at', 'updated_by', 'published_at', 'long_description'], 'safe'],
        ];
    }
